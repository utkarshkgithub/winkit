"""
Django settings for winkit project.
...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-b@sc*=0pd3r0%h328n!_rzu@t!lcz*q2oin^pu(pt6sn2sr@4r')
...
WSGI_APPLICATION = 'winkit.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        } if config('DB_ENGINE', default='').startswith('postgresql') else {},
    }
}
...
REST_FRAMEWORK = {
    ...
    # Pagination disabled - all products returned at once
